...
def lf_segmentations(device, dataset_num,sens_idx=7):
    ...
    lf_wm_location = "./sashimi/sensitivity_data/" + str(sens_idx) + "/fast_pve_2.nii.gz"
    lf_gm_location = "./sashimi/sensitivity_data/" + str(sens_idx) + "/fast_pve_1.nii.gz"
    lf_csf_location = "./sashimi/sensitivity_data/" + str(sens_idx) +"/fast_pve_0.nii.gz"
...
def get_lf_gt(device, dataset_num, sens_idx=7):
    lf_gt_loc = "./sashimi/sensitivity_data/ulf_imgs/ulf_" + str(sens_idx) + ".nii.gz"
...
def get_M(device, dataset_num, sens_idx=7):
    sens_exp_values = "./sashimi/sensitivity_data/sensitivity_exp_values.csv"
