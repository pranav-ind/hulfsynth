...
commands=(
    "CUDA_VISIBLE_DEVICES=0 python hyperparam_1.py -dn 102 -id 1  > ./vili_jobs_log/sens1_output.txt"
    "CUDA_VISIBLE_DEVICES=1 python hyperparam_1.py -dn 102 -id 2 > ./vili_jobs_log/sens2_output.txt"
    "CUDA_VISIBLE_DEVICES=2 python hyperparam_1.py -dn 102 -id 3  > ./vili_jobs_log/sens3_output.txt"
    "CUDA_VISIBLE_DEVICES=3 python hyperparam_1.py -dn 102 -id 4  > ./vili_jobs_log/sens4_output.txt"
