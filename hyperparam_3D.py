...
def wand_train():
    ...
    with run:
        ...
        config_["total_steps"] = wandb.config.epochs
        config_["w0"] = wandb.config.w0
        config_["l3"] = wandb.config.l3
        config_["l4"] = wandb.config.l4
        # config["l5"] = [1.5, 1.5, 1.5, 5]
        # config["l1"] = 1.25
...
if __name__ == '__main__':
    ...
    sweep_config = {
        ...
        # 'l5': {'values': [ [1.5, 1.5, 1.5, 5], [2, 2, 2, 5] , [2.5, 2.5, 2.5, 5], [5, 5, 5, 25]]},
        # 'l4': {'values': [ [0.6, 0.6, 0.6, 5], [0.75, 0.75, 0.75, 5], [1, 1, 1, 1] , [2.5, 2.5, 2.5, 5]]},
